              ...
              <div class="action_info d-flex gap-4 align-items-center">
                <div class="icon_box position-relative">
                  <button class="icon_btn dropdown_menu bg-transparent border-0 position-relative">
                    ...
                    <sup class="notification_number position-absolute rounded-pill d-flex justify-content-center align-items-center">
                      5
                    </sup>
                  </button>
                  <div class="information_box dropdown_menu_info notification_information position-absolute top-100 end-0">
                    <div class="top d-flex justify-content-between align-items-center gap-4">
                      <h3 class="title">Notification</h3>
                      <button class="clear bg-transparent border-0">
                        Clear
                      </button>
                    </div>
                    <div class="list">
